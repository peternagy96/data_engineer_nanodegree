...
def process_song_data(spark, input_data, output_data):
    ...
    songs_table = df['song_id', 'title', 'artist_id','artist_name', 'year', 'duration'].distinct()
...
def process_log_data(spark, input_data, output_data):
    ...
    users_table = df['userId', 'firstName', 'lastName', 'gender', 'level','ts'].distinct()
    ...
    songplays_table.write.parquet(output_data + "songplays.parquet", "overwrite")
